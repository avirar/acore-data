...
# ============================================================================
# Spell effect enum (SharedDefines.h SpellEffects)
# ============================================================================
SPELL_EFFECT_NAMES = {
    0: "INSTAKILL",
    1: "SCHOOL_DAMAGE",
    ...
    11: "PORTAL",
    12: "RITUAL_BASE",
    13: "RITUAL_SPECIALIZE",
    14: "RITUAL_ACTIVATE_PORTAL",
    15: "QUEST_COMPLETE",
    16: "WEAPON_DAMAGE_NOSCHOOL",
    17: "RESURRECT",
    18: "ADD_EXTRA_ATTACKS",
    19: "DODGE",
    20: "EVADE",
    21: "PARRY",
    22: "BLOCK",
    ...
    45: "DETECT",
    46: "TRANS_DOOR",
    47: "PERSISTENT_AREA_AURA2",
    48: "SUMMON_TOTEM",
    49: "HEAL_MECHANICAL",
    50: "SUMMON_OBJECT_WILD",
    51: "SCRIPT_EFFECT",
    52: "ATTACK",
    53: "SANCTUARY",
    54: "ADD_COMBO_POINTS",
    ...
    59: "SUMMON_PLAYER",
    60: "ACTIVATE_OBJECT",
    61: "GAMEOBJECT_DAMAGE",
    62: "GAMEOBJECT_REPAIR",
    63: "GAMEOBJECT_SET_DESTRUCTION_STATE",
    64: "KILL_CREDIT",
    65: "THREAT_ALL",
    66: "ENCHANT_HELD_ITEM",
    67: "FORCE_DESELECT",
    68: "SELF_RESURRECT",
    69: "SKINNING",
    70: "CHARGE",
    ...
    74: "WAND_DAMAGE",
    75: "FISHING",
    76: "SUMMON_TOTEM_SLOT1",
    77: "SUMMON_TOTEM_SLOT2",
    78: "SUMMON_TOTEM_SLOT3",
    79: "SUMMON_TOTEM_SLOT4",
    80: "THREAT_SINGLE",
    81: "SUMMON_CRITTER",
    82: "SUMMON_OBJECT_SLOT1",
    83: "SUMMON_OBJECT_SLOT2",
    84: "SUMMON_OBJECT_SLOT3",
    85: "SUMMON_OBJECT_SLOT4",
    86: "DISPEL_MECHANIC",
    87: "SUMMON_DEAD_PET",
    88: "DESTROY_ALL_TOTEMS",
    89: "DURABILITY_DAMAGE",
    90: "SUMMON_PET2",
    91: "SUMMON_CRITTER2",
    92: "SUMMON_OBJECT_SLOT_EXTRA",
    93: "EXTRA_ATTACKS2",
    94: "SPELL_FOCUS_OBJECT",
    95: "PLAYER_NOTIFICATION",
    96: "ACTIVATE_RUNE",
    97: "CREATE_ITEM2",
    98: "MISSILE",
    99: "TAUNT",
    100: "DURABILITY_DAMAGE_PCT",
    101: "CLEAVE",
    102: "CANCEL_AUTO_REPEAT",
    103: "RAPID_REGEN",
    104: "RAID_MARK",
    105: "HEAL_PCT",
    106: "INTERRUPT_CAST",
    ...
    108: "PULL",
    109: "PICKPOCKET",
    110: "MODIFY_THREAT_PCT",
    111: "STEAL_BENEFICIAL_BUFF",
    112: "PROSPECTING",
    113: "APPLY_AREA_AURA_OWNER",
    114: "APPLY_AREA_AURA_ENEMY",
    115: "SANCTUARY2",
    116: "ADD_FARSIGHT",
    117: "SUMMON_POSSESSED",
    118: "SUMMON_PHANTASM",
    119: "FEED_PET",
    120: "DISMISS_PET",
    121: "REPUTATION",
    122: "SUMMON_OBJECT_SLOT5",
    123: "SPECIAL_SPELL_DAMAGE",
    124: "SUMMON_TOTEM_SLOT_PROP",
    125: "SUMMON_VEHICLE",
    126: "SEND_TAXI",
    127: "PULL_TOWARDS",
    128: "MODIFY_SPELL_COOLDOWN",
    129: "CREATE_ARENA_TEAM",
    130: "HEAL_BONUSDAMAGE",
    131: "APPLY_AREA_AURA_FRIEND",
    132: "APPLY_AREA_AURA_ENEMY2",
    133: "SET_PHASE",
    134: "SET_POWER",
    135: "SCARE",
    136: "MILLING",
    ...
    139: "UNKNOWN140",
    140: "DESTROY_ITEM",
    141: "DESTROY_ALL_ITEMS",
    142: "UPDATE_ZONE",
    143: "SUMMON_RAF_FRIEND",
    144: "ROLL",
    145: "DURABILITY_DAMAGE_PCT2",
    146: "SUMMON_QUEST_VEHICLE",
    147: "SUMMON_VEHICLE2",
    148: "SUMMON_MUSIC_DUMMY",
    149: "DISPEL_MECHANIC2",
    150: "SUMMON_CRITTER3",
    151: "STABLE_PET",
    152: "GIVE_EXPERIENCE",
    153: "GIVE_HONOR",
    154: "DESTROY_ALL_TOTEMS2",
    155: "CHECK_RESET_COOLDOWN",
    156: "BATTLE_PET_STATUS",
    157: "CREATE_RANDOM_ITEM",
    158: "HEAL_BATTLE_PET_PCT",
    159: "APPLY_AREA_AURA_FRIEND2",
    160: "TRADE",
    161: "FORCE_DESELECT2",
    162: "UNKNOWN163",
    163: "UNKNOWN164",
    ...
    165: "UNKNOWN166",
    166: "LEARN_GLYPH",
    167: "DISPEL_MECHANIC3",
    168: "CLEAR_QUEST",
}

# ============================================================================
# Spell implicit target enum (SharedDefines.h Targets)
# ============================================================================
SPELL_TARGET_NAMES = {
    0: "NONE",
    1: "UNIT_CASTER",
    ...
    16: "UNIT_SRC_AREA_ALLY",
    17: "UNIT_SRC_AREA_PARTY",
    18: "UNIT_TARGET_ENEMY_WITH_LOG",
    19: "UNIT_TARGET_ANY",
    20: "UNIT_SRC_AREA_ENEMY2",
    21: "UNIT_TARGET_ALLY",
    22: "DEST_CASTER",
    23: "UNIT_CASTER_AREA_PARTY",
    24: "UNIT_TARGET_ANY2",
    25: "UNIT_TARGET_ANY3",
    26: "DEST_TARGET_ENEMY",
    27: "DEST_DYNOBJ_ENEMY",
    28: "DEST_DYNOBJ_ALLY",
    29: "UNIT_TARGET_AREA_ENEMY",
    30: "UNIT_CASTER_AREA_PARTY2",
    31: "UNIT_TARGET_AREA_PARTY",
    32: "UNIT_TARGET_AREA_ALLY2",
    33: "UNIT_CASTER_AREA_ENEMY",
    34: "UNIT_CASTER_AREA_ALLY",
    35: "UNIT_TARGET_PARTY",
    36: "DEST_CASTER_SUMMON",
    37: "UNIT_TARGET_AREA_ENEMY2",
    38: "UNIT_CASTER_AREA_ALLY2",
    39: "UNIT_CASTER_AREA_PARTY3",
    40: "TARGET_NOTHING",
    41: "DEST_TARGET_ENEMY2",
    42: "UNIT_DEST_AREA_ENEMY",
    43: "UNIT_DEST_AREA_ALLY",
    44: "UNIT_DEST_AREA_PARTY",
    45: "UNIT_TARGET_CHAINHEAL_ALLY",
    46: "DEST_DEST",
    47: "DEST_DYNOBJ_NONE",
    48: "DEST_DEST_UNK_48",
    49: "DEST_DEST_UNK_49",
    50: "DEST_TARGET_ENEMY3",
    51: "DEST_DYNOBJ_ENEMY2",
    52: "DEST_DYNOBJ_ALLY2",
    53: "DEST_DEST_UNK_53",
    54: "DEST_DEST_UNK_54",
    55: "DEST_DEST_UNK_55",
    56: "DEST_DEST_UNK_56",
    57: "UNIT_TARGET_RAID",
    58: "DEST_DYNOBJ_CASTER",
    59: "DEST_DEST_UNK_59",
    60: "DEST_DEST_UNK_60",
    61: "UNIT_TARGET_AREA_RAID_CLASS",
    62: "DEST_DEST_CHANNEL_TARGET",
    63: "UNIT_CHANNEL_TARGET",
    64: "DEST_DEST_CHANNEL_CASTER",
    65: "UNIT_CHANNEL_CASTER",
    66: "DEST_DEST_UNK_66",
    67: "DEST_DEST_UNK_67",
    68: "DEST_DEST_UNK_68",
    69: "DEST_DEST_UNK_69",
    ...
    96: "DEST_DEST_UNK_96",
    97: "UNIT_SUMMONER",
    98: "CORPHE_SRC_AREA_ENEMY",
    99: "UNIT_VEHICLE",
    100: "UNIT_TARGET_MULTIPLE",
    101: "UNIT_DEST_AREA_ALLY2",
    102: "UNIT_DEST_AREA_ENEMY2",
    103: "DEST_DEST_UNK_103",
}

# ============================================================================
# Item class enum (SharedDefines.h ItemClass)
# ============================================================================
ITEM_CLASS_NAMES = {
    0: "CONSUMABLE",
    1: "CONTAINER",
...
# ============================================================================
# Item subclass enums (SharedDefines.h) - most commonly needed
# ============================================================================
ITEM_SUBCLASS_CONSUMABLE = {
    0: "CONSUMABLE", 1: "POTION", 2: "ELIXIR", 3: "FLASK",
    4: "SCROLL", 5: "FOOD_DRINK", 6: "ITEM_ENHANCEMENT",
    7: "BANDAGE", 8: "CONSUMABLE_OTHER",
}

ITEM_SUBCLASS_WEAPON = {
    0: "AXE1H", 1: "AXE2H", 2: "BOW", 3: "GUN", 4: "MACE1H",
    5: "MACE2H", 6: "POLEARM", 7: "SWORD1H", 8: "SWORD2H",
    9: "WARGLAIVE", 10: "STAFF", 11: "EXOTIC1H", 12: "EXOTIC2H",
    13: "FIST_WEAPON", 14: "MISC_WEAPON", 15: "DAGGER", 16: "THROWN",
    17: "SPEAR", 18: "CROSSBOW", 19: "WAND", 20: "FISHING_POLE",
}
...
ITEM_SUBCLASS_MISC = {
    0: "JUNK", 1: "REAGENT", 2: "COMPANION_PET", 3: "HOLIDAY",
    4: "OTHER", 5: "MOUNT",
}
...
ITEM_SUBCLASS_MAP = {
    0: ITEM_SUBCLASS_CONSUMABLE,
    2: ITEM_SUBCLASS_WEAPON,
    4: ITEM_SUBCLASS_ARMOR,
    13: ITEM_SUBCLASS_MISC,
    14: ITEM_SUBCLASS_GLYPH,
}
